...
//		Checking if the email is not null and the authentication is not done yet
...
//				If valid then generating EmailPasswordAuthenticationToken to denote that the user is authenticated				
...
//				Injecting the details to EmailPasswordAuthenticationToken
				upToken.setDetails(webAuthDetails);
				
//				Injecting the EmailPasswordAuthenticationToken into the SecurityContext Holder
